...
public class GroupChatAdapter extends RecyclerView.Adapter<GroupChatAdapter.MyViewHolder> {
    ...
    public GroupChatAdapter(Context context, List<ModelGroupChat> chatList) {
...
//클릭시 삭제 이벤트
    ...
    private void deleteMessage(int position) {
        ...
        DatabaseReference dbRef = FirebaseDatabase.getInstance().getReference("GroupChats").child("Messages");
