            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : snapshot.getChildren()){
                    ...
                    if(!ds.child("participants").child(member_id).exists()){
                        ...
                        String GroupLeader = ds.child("GroupLeader").getValue(String.class);
                        String GroupDescription = ds.child("GroupDescription").getValue(String.class);
                        String GroupId = ds.child("GroupId").getValue(String.class);
                        String GroupMaxMember = ds.child("GroupMaxMember").getValue(String.class);
                        String GroupCurrentJoinedMember = ds.child("GroupCurrentJoinedMember").getValue(String.class);
                        String Group_date_issued = ds.child("Group_date_issued").getValue(String.class);
                        String participants = ds.child("participants").getValue(String.class);
                        Log.e("[test",""+ds.getRef());
                        Log.e("[test]",GroupName);
                        Log.e("[test]",GroupLeader);
                        Log.e("[test]",GroupDescription);
                        Log.e("[test]",GroupId);
                        Log.e("[test]",GroupMaxMember);
                        Log.e("[test]",GroupCurrentJoinedMember);
                        Log.e("[test]",Group_date_issued);
                        Log.e("[test]",participants);
