            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                for(int i=0; i<str_check.size(); i++) {
                    if (str_check.get(i).equals(select_gu)) {
                        Toast.makeText(EditMyInfoActivity.this, "이미 선택한 지역입니다.", Toast.LENGTH_SHORT).show();
        ...
        builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(ischecked2) {
                    ...
                    Toast.makeText(EditMyInfoActivity.this, "최소 1개의 지역을 선택해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                }
                last_selected_gu = "";
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                for(int i=0; i<str_check.size(); i++) {
                    if (str_check.get(i).equals(select_tag)) {
                        Toast.makeText(EditMyInfoActivity.this, "이미 선택한 태그입니다.", Toast.LENGTH_SHORT).show();
                        spinner_tag.setSelection(0);
                        return;
                    }
                }
